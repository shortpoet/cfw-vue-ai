<template>
  <ul>
    <li>
      ...
      <img v-else :src="githubUser?.image" class="w-8 h-8 rounded-full" />
      </Link>
    </li>
...
import Login from '@/ui/src/components/base/Login.vue';
import { useAuthStore } from '@/ui/src/stores';
...
export default {
  ...
  setup(props) {
    ...
    const loggedIn = ref(isLoggedIn && !!user.value);
    const githubUser = ref<GithubUser>();
    ...
    // watch(() => isGhUser, () => {
    //   console.log('isGhUser changed');
    //   console.log(`[ui] ProfileGithub setup loggedIn: ${loggedIn.value}`)
    //   console.log(`[ui] ProfileGithub setup user: ${user.value}`)
    //   console.log(`[ui] ProfileGithub setup githubUser: ${githubUser.value}`)
    //   console.log(user.value)
    //   console.log(`[ui] ProfileGithub setup isGithubUser: ${isGhUser.value}`)
    //   console.log(isGhUser.value)
    //   console.log(`[ui] ProfileGithub setup session: ${session}`)
    //   console.log(session)
    //   if (loggedIn.value && isGhUser.value) {
    //     console.log('user is a github user');
    //     githubUser.value = user.value
    //   }
    // });
    // watch(() => session, () => {
